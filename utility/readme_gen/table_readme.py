...
target.write("|")
target.write("This example shows how to use array partitioning to improve performance of a hardware function")
target.write("|")
...
target.write("|")
target.write("This is a simple example of RGB to HSV conversion to demonstrate Custom DATA Type usage in hardware accelerator. Xilinx HLS compiler supports custom data type to operate within the hardware function and also it acts as a memory interface between PL to DDR")
target.write("|")
...
target.write("|")
target.write("This example demonstrates how loop pipelining can be used to improve the performance of a hardware function")
target.write("|")
...
target.write("[Loop Pipelining]:https://gitenterprise.xilinx.com/SDSoC-Examples/apps/tree/master/cpp/getting_started/loop_pipeline\n")
target.write("[Loop Reorder for Better Performance]:https://gitenterprise.xilinx.com/SDSoC-Examples/apps/tree/master/cpp/getting_started/loop_reorder\n")
