...
set ID 2
set MemName mean_value_accel_bkb
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    max_latency -1 \ 
    delay_budget 6.125 \ 
    name {mean_value_accel_in_r_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler mean_value_accel_in_r_m_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    max_latency -1 \ 
    delay_budget 6.125 \ 
    name {mean_value_accel_out_r_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler mean_value_accel_out_r_m_axi
}
