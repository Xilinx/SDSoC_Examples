...
set Library     "hls"
set IPName      "mean_value_accel"
set Version     "1.0"
set DisplayName "Mean_value_accel"
set Revision    "1704211515"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "mean_value_accel"
...
set Interfaces {
    ...
    m_axi_in_r {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_in_r"
        data_width "32"
        param_prefix "C_M_AXI_IN_R"
    ...
    m_axi_out_r {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_out_r"
        data_width "32"
        param_prefix "C_M_AXI_OUT_R"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 7.000001 machine 64 combinational 0 latency 2566 II x}
...
set enable_xo_gen 0
set kernel_files {/proj/xhdhdstaff2/kalib/sprite_makefile_dev/apps/cpp/getting_started/dependence_inter/src/mean_value.cpp}
if {$enable_xo_gen} {
