...
#ifndef __mean_value_accel_cud__HH__
#define __mean_value_accel_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mean_value_accel_cud) {
    ...
    SC_CTOR(mean_value_accel_cud):  ACMP_mul_us_U ("ACMP_mul_us_U") {
