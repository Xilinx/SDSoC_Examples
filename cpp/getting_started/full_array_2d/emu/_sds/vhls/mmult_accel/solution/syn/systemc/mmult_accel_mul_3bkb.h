...
#ifndef __mmult_accel_mul_3bkb__HH__
#define __mmult_accel_mul_3bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mmult_accel_mul_3bkb) {
    ...
    SC_CTOR(mmult_accel_mul_3bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
