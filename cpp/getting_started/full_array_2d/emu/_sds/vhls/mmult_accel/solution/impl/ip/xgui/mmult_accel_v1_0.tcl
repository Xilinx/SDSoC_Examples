...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M_AXI_C_ENABLE_ID_PORTS" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_C_ID_WIDTH" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_C_DATA_WIDTH" -parent ${group_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_M_AXI_C_ENABLE_USER_PORTS" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_C_AWUSER_WIDTH" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_C_WUSER_WIDTH" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_C_BUSER_WIDTH" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_C_ARUSER_WIDTH" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_C_RUSER_WIDTH" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_C_USER_VALUE" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_C_PROT_VALUE" -parent ${group_0}
  ipgui::add_param $IPINST -name "C_M_AXI_C_CACHE_VALUE" -parent ${group_0}
...
proc update_PARAM_VALUE.C_M_AXI_C_ENABLE_ID_PORTS { PARAM_VALUE.C_M_AXI_C_ENABLE_ID_PORTS } {
	# Procedure called to update C_M_AXI_C_ENABLE_ID_PORTS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_AXI_C_ENABLE_ID_PORTS { PARAM_VALUE.C_M_AXI_C_ENABLE_ID_PORTS } {
	# Procedure called to validate C_M_AXI_C_ENABLE_ID_PORTS
	return true
}
...
proc update_PARAM_VALUE.C_M_AXI_C_ENABLE_USER_PORTS { PARAM_VALUE.C_M_AXI_C_ENABLE_USER_PORTS } {
	# Procedure called to update C_M_AXI_C_ENABLE_USER_PORTS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_AXI_C_ENABLE_USER_PORTS { PARAM_VALUE.C_M_AXI_C_ENABLE_USER_PORTS } {
	# Procedure called to validate C_M_AXI_C_ENABLE_USER_PORTS
	return true
}
